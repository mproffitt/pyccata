...
from releaseessentials.exceptions    import RequiredKeyError, InvalidClassError
...
class TestConfiguration(TestCase):
    ...
    @patch('releaseessentials.configuration.Configuration._get_locations')
    @patch('releaseessentials.configuration.Configuration.validate_config')
    ...
    def test_configuration_calls_validation_once_config_is_loaded(self, data_key, data_driver, mock_config_list, mock_load):
        ...
        with patch(
            'releaseessentials.configuration.Configuration.{0}'.format(data_key),
